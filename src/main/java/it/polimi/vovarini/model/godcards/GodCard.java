...
public class GodCard implements Serializable {
  ...
  public int hashCode() {
    ...
    result = 31 * result + isPointBuildable.hashCode();
    result = 31 * result + nextPhase.hashCode();
    result = 31 * result + listMovementEffects.hashCode();
    result = 31 * result + listConstructionEffects.hashCode();
    result = 31 * result + validateMovement.hashCode();
    result = 31 * result + validateConstruction.hashCode();
    result = 31 * result + isMovementWinning.hashCode();
    result = 31 * result + constraintMovement.hashCode();
    result = 31 * result + movementConditions.hashCode();
    result = 31 * result + movementConstraints.hashCode();
    result = 31 * result + constructionConditions.hashCode();
    result = 31 * result + constructionConstraints.hashCode();
